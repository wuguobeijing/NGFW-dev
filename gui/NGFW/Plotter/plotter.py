...
class Plotter:
    ...
    def __init__(self, __window):
        ...
        __photo = PhotoImage(
            file="/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/logo.png")
        self.__window.iconphoto(False, __photo)

        # Frames in the main window
        self.__thisframe1 = Frame(self.__window, width=300, height=650, highlightbackground='#454545',
                                  highlightthickness=0,
                                  bg='#454545')
        self.__thisframe2 = Frame(self.__window, width=1000, height=650, highlightbackground='#3498DB',
                                  highlightthickness=0,
                                  bg='white')
        self.__thisframe3 = Frame(self.__thisframe2, width=80, height=600, highlightbackground='#3498DB',
                                  highlightthickness=0,
                                  bg='#221870')
        self.__thisframe4 = Frame(self.__thisframe2, width=800, height=600, highlightbackground='#454545',
                                  highlightthickness=1,
                                  bg='white')

        # Lables for logo and name of application
        self.__photo0 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/图表.png")
        self.__l00 = Label(self.__thisframe1, image=self.__photo0, bd=0)
        self.__l01 = Label(self.__thisframe1, text="NGFW Plot", fg="white", font=('arial', 26, 'bold'), bg='#454545')

        # Label and option menu to select plot type

        self.__clicked1 = StringVar()  # Variable to store selected plot-type option value
        self.__clicked1.set(' Select ')
        __plots = ['Scatterplot', 'Barplot', 'Lineplot']  # plot types list
        self.__thisdrop1 = OptionMenu(self.__thisframe1, self.__clicked1, *__plots)
        self.__l1 = Label(self.__thisframe1, text="plot type : ", fg="white", font=('arial', 12, 'bold'), bg='#454545')

        # Text Area to display text on window
        self.__thisTextArea = Text(self.__thisframe4, padx=80, spacing2=5, bg='white', fg='blue', height=33, width=79,
                                   pady=30)

        # Canvas to show plots on window
        self.__thiscanvas = Canvas(self.__thisframe4, width=794, height=594, bg="white")
        self.__f = Figure(figsize=(7, 7), dpi=80)
        self.__a = self.__f.add_subplot(111)
        self.__thiscanvasf = FigureCanvasTkAgg(self.__f, master=self.__thisframe4)

        # Images used for button widgets

        self.__photo1 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/uploads.png")
        self.__photo2 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/plots.png")
        self.__photo3 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/data.png")
        self.__photo4 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/desc.png")
        self.__photo5 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/info.png")
        self.__photo6 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/Button(4).png")
        self.__photo7 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/Button(3).png")
        self.__photo8 = PhotoImage(
            file=r"/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/NGFW-dev/gui/NGFW/Plotter/img/Button(2).png")
        ...
        # Buttons Used
        self.__b1 = Button(self.__thisframe3, image=self.__photo1, bg='#221870', activebackground='#221870', bd=0,
                           command=self.getCSV)
        self.__b2 = Button(self.__thisframe3, image=self.__photo2, bg='#221870', activebackground='#221870', bd=0,
                           command=self.plot)
        self.__b3 = Button(self.__thisframe3, image=self.__photo3, bg='#221870', activebackground='#221870', bd=0,
                           command=self.getData)
        self.__b4 = Button(self.__thisframe3, image=self.__photo4, bg='#221870', activebackground='#221870', bd=0,
                           command=self.descript)
        self.__b5 = Button(self.__thisframe3, image=self.__photo5, bg='#221870', activebackground='#221870', bd=0,
                           command=self.getInfo)
        self.__b6 = Button(self.__thisframe1, image=self.__photo6, bg='#454545', activebackground='#454545', bd=0,
                           command=self.clear)
        self.__b7 = Button(self.__thisframe1, image=self.__photo7, bg='#454545', activebackground='#454545', bd=0,
                           command=self.help)
        self.__b8 = Button(self.__thisframe1, image=self.__photo8, bg='#454545', activebackground='#454545', bd=0,
                           command=self.quit)
        ...
        self.__l2 = Label(self.__thisframe1, text="column1 : ", height=2, fg="white", font=('arial', 12, 'bold'),
                          bg='#454545')
        self.__l3 = Label(self.__thisframe1, text="column2 : ", height=2, fg="white", font=('arial', 12, 'bold'),
                          bg='#454545')
    ...
    def getData(self):
        ...
        if self.__import_file_path != None and self.__df.empty != True:
            ...
            self.__thisTextArea.insert(1.0, "#--------      Data in the Dataset (" + os.path.basename(
                self.__import_file_path) + ")      --------#\n\n\n\n")
    ...
    def descript(self):
        ...
        if self.__import_file_path != None and self.__df.empty != True:
            ...
            self.__thisTextArea.delete(1.0, END)
            self.__thisTextArea.insert(1.0,
                                       "#--------    This is Description of Numerical Data in Dataset    --------#\n\n\n\n")
    ...
    def getInfo(self):
        ...
        if self.__import_file_path != None and self.__df.empty != True:
            ...
            s = buffer.getvalue()
            self.__thisTextArea.insert(1.0, "#--------   Info about Data in the Dataset (" + os.path.basename(
                self.__import_file_path) + ")  --------#\n\n\n\n")
